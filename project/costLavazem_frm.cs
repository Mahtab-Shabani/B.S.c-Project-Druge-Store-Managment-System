...
namespace project
{
    public partial class costLavazem_frm : Form
    {

        ClassCostLavazem ccl = new ClassCostLavazem();
        public costLavazem_frm()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dataGridView1.Columns[2].HeaderText = "شرکت سازنده";
            ...
            txt_cost.Text = dataGridView1[3, cr].Value.ToString();
            txt_composer.Text = dataGridView1[2, cr].Value.ToString();
        }

        private void btn_show_Click(object sender, EventArgs e)
        {
            DataTable dt = ccl.show();
        ...
        private void btn_insert_Click(object sender, EventArgs e)
        {
            ...
            if (txt_cost.Text == "" || txt_name.Text == "")
            {
                if (txt_name.Text == "")
            ...
            {
                ccl.insert(txt_name.Text, txt_composer.Text, txt_cost.Text);
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            else if (txt_cost.Text == "" || txt_name.Text == "")
            {
                if (txt_name.Text == "")
                    txt_name.BackColor = Color.Red;
                if (txt_cost.Text == "")
            ...
            {
                 ccl.update(txt_name.Text, txt_composer.Text, txt_cost.Text, int.Parse(txt_idd.Text));
                 btn_show_Click(null, null);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                ccl.delete(int.Parse(txt_idd.Text));
                btn_show_Click(null, null);
            }
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt2 = ccl.search(txt_name.Text);
